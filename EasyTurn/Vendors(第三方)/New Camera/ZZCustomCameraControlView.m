...
-(void)initUI
{
    ...
    /// 拍一下，去问问题
    UILabel *subLb = [UILabel zz_labelWithTitle:@"" color:UIColor.whiteColor fontSize:10];
    subLb.numberOfLines = 0;
    [self addSubview:subLb];
    
    UILabel *titleLb = [UILabel zz_labelWithTitle:@"" color:UIColor.whiteColor fontSize:14];
    ...
    /// 跳过
    self.skipBtn = [UIButton zz_buttonWithTitle:@"" color:UIColor.whiteColor fontSize:14 target:self action:@selector(skip)];
...
//    }];
    ...
    /// 纯文字提示
//    self.skipSynopsis = [UILabel zz_labelWithTitle:@"" color:UIColor.whiteColor fontSize:8];
