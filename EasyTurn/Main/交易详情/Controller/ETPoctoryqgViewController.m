...
//
@interface ETSaleCollectBtn1 : UIButton

@end

@implementation ETSaleCollectBtn1
...
@interface ETSaleTelBtn1 : UIButton

@end

@implementation ETSaleTelBtn1
...
@interface ETPoctoryqgViewController ()
...
//
@property (nonatomic,strong) ETSaleCollectBtn1 *btnCollect;
@property (nonatomic,strong) ETSaleTelBtn1 *btnChat;
@property (nonatomic,strong) ETSaleTelBtn1 *btnTel;

@end

@implementation ETPoctoryqgViewController
...
- (void)viewDidLoad {
    ...
    [self.view addSubview:self.jibenLab];
    ...
    [_cenView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(self.conLab.mas_bottom).with.offset(10);
    ...
    [self.view addSubview:self.qitaLab];
    ...
    [self.view addSubview:self.fundusView];
    ...
    else
    {
        ...
        self.btnCollect = [ETSaleCollectBtn1 buttonWithType:UIButtonTypeCustom];
        ...
        //
        self.btnChat = [ETSaleCollectBtn1 buttonWithType:UIButtonTypeCustom];
        ...
        self.btnTel = [ETSaleCollectBtn1 buttonWithType:UIButtonTypeCustom];
...
- (void)PostUI {
    ...
    [HttpTool get:[NSString stringWithFormat:@"release/releaseDetail"] params:params success:^(id responseObj) {
        ...
        UserInfoModel* m=[UserInfoModel loadUserInfoModel];
        ETProductModel* p1=[ETProductModel mj_objectWithKeyValues:self.detailInfo];
        if ([m.uid isEqualToString:p1.userId]) {
            [self.moreBtn setImage:[UIImage imageNamed:@"sale_更多"] forState:UIControlStateNormal];
        }
