...
@interface PersonalVC ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
{
    ...
    if (indexPath.section == 0) {
        ...
        if (!cell) {
            ...
            if (indexPath.row==0) {
                ...
                img.image = [UIImage imageNamed:@"身份认证-分组 3"];
            }
