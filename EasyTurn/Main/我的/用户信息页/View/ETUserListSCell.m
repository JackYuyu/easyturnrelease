...
@implementation ETUserListSCell
...
//        self.labelPrice.textColor = RGBACOLOR(248, 124, 43, 1);
        ...
        self.imvLine = [[UIImageView alloc] initWithFrame:CGRectMake(0, [ETUserListSCell cellHeight]-1, Screen_Width, 1)];
...
//    }
    ETUserListSCell* cell=[ETUserListSCell new];
    [cell resetDict:dict];
    return cell;
}
