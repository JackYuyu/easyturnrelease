...
@interface ETFrequencyViewAppController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ETFrequencyViewAppController
- (UIView *)maskTheView{
    if (!_maskTheView) {
...
{
    MEVIPTableViewCell0*cell=[[MEVIPTableViewCell0 alloc]initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:@"cell"];
