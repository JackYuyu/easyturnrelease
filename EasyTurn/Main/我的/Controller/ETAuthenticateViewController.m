...
- (void)viewDidLoad {
    ...
    self.PageView = [[MCPageView alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width,Screen_Height-StatusBarHeight-NavBarHeight) titles:titles controllers:controllers];
