...
//        self.labelPrice.textColor = RGBACOLOR(248, 124, 43, 1);
        ...
        self.imvLine = [[UIImageView alloc] initWithFrame:CGRectMake(0, [ETFootListCell cellHeight]-1, Screen_Width, 1)];
...
//    }
    ETFootListCell* cell=[ETFootListCell new];
    [cell resetDict:dict];
    return cell;
}
