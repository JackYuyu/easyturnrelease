...
- (UICollectionView *)contentCollection
{
    if (!_contentCollection) {
        ...
        if (@available(iOS 11.0, *)) {
            [_contentCollection setContentInsetAdjustmentBehavior:UIScrollViewContentInsetAdjustmentNever];
        }
#endif
    }
...
#if __IPHONE_OS_VERSION_MAX_ALLOWED>=__IPHONE_11_0
        if (@available(iOS 11.0, *)) {
            [_titleScroll setContentInsetAdjustmentBehavior:UIScrollViewContentInsetAdjustmentNever];
        }
#endif
